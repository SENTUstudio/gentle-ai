...
func TestEmbeddedAssetCount(t *testing.T) {
	...
	// We expect 26 skill directories (10 SDD + judgment-day + 6 foundation + 4 sustainable-review + hermes-ephemeral-delegation + _shared + 3 data-engineering: pattern-detect, study-file, create-table).
	if skillDirs != 26 {
